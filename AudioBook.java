...
public class AudioBook extends AudioContent
{
  ...
  // Print information about the audiobook. First print the basic information of the AudioContent 
	...
	{
		// Call the super.printInfo method from the superclass to print the title, id, year, type, length.
		super.printInfo();

		// Print the author and narrator.
  ...
  // Play the audiobook by setting the audioFile to the current chapter title (from chapterTitles array list) 
	...
	{
		// Create a for loop that loops as many times as there are chapters in the audio book.
		for (int i = 0; i < chapters.size(); i++)
		{
			// Print the chapter number followed by the title, then skip a line.
	...
	public boolean equals(Object other)
	{
		...
		return(super.equals(other) && author.equals(other2.author) && narrator.equals(other2.narrator));
	}
