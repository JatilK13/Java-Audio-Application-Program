...

{
	...
	{
		// Type cast the parameter to a song object.
		Song other2 = (Song) other;

		// Call the super.equals() method and check if the composer and artist is the same.
		return(super.equals(other) && composer.equals(other2.composer) && artist.equals(other2.artist));
	}
